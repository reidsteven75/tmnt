		...
		this.sk.draw = () => {
			...
			for (var x = 0; x < canvasWidth; x += canvasWidth / gridDimensions) {
				for (var y = 0; y < canvasHeight; y += canvasHeight / gridDimensions) {
					...
					this.sk.strokeWeight(0.1);
					this.sk.line(x, 0, x, canvasHeight);
					this.sk.line(0, y, canvasWidth, y);
				}
			}
			...
			// TODO: figure out rotation edge cases below
			// if (currentRotation <= 5 && currentRotation >= 0 && nextRotation === 270) {
			// 	currentRotation = 360
			// }
			// else if (currentRotation <= 5 && currentRotation >= 0 && nextRotation === 0) {
			// 	drot = 90
			// }
			// else {
			...
			this.setState({
				...
				currentRotation: currentRotation + drot * easing,
